          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-3 text-muted-foreground font-sans">
                ...
                <div className="border-l-2 border-accent/30 pl-4">
                  <p className="font-semibold text-foreground">Mestrado em Sociologia </p>
                  <p className="text-sm"> Universidade Federal do Ceará (1987)</p>
                </div>
                      <div className="border-l-2 border-accent/30 pl-4">
                  <p className="font-semibold text-foreground">graduação em História pela Universidade Federal do Ceará (1983) </p>
                  <p className="text-sm"> Universidade Federal do Ceará (1983)</p>      
            </div>
          </div>
        </div>
      </section>
